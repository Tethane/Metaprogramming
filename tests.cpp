...
using ScriptMathSymbolicResult = EvalScript_t<generated_scripts::math_symbolic_source>;
using ScriptMathApproxResult = ReadScriptApprox_t<generated_scripts::math_approx_source, 12>;
using ScriptVectorMathResult = EvalScript_t<generated_scripts::vector_math_source>;
using ScriptMatrixMathResult = EvalScript_t<generated_scripts::matrix_math_source>;
using ScriptComplexMathResult = EvalScript_t<generated_scripts::complex_math_source>;
using ScriptStatsMathResult = EvalScript_t<generated_scripts::stats_math_source>;
using RationalFiveHalves = Rational_t<BigIntLiteral_t<"5">, BigIntLiteral_t<"2">>;
using MatrixProductExpected = Matrix<Vector<Int<19>, Int<22>>, Vector<Int<43>, Int<50>>>;
using ComplexSumExpected = Complex<Int<4>, Int<6>>;
using DotStats = NormalizeWithStats_t<Apply_t<Dot, VectorExampleA, VectorExampleB>>;
...
static_assert(IsSame<ReaderUntypedIdentityType, IntType>::value);
...
static_assert(IsSame<ReaderBoolProgramType, IntType>::value);
static_assert(IsSame<ReaderDefinedFactorialResult, Int<120>>::value);
static_assert(IsSame<ReaderDefinedFactorialType, IntType>::value);
static_assert(IsSame<ReaderListInferenceResult, Nat<3>>::value);
static_assert(IsSame<ReaderListInferenceType, NatType>::value);
static_assert(IsSame<ReaderRecursiveValueDefineError, EvalError<msg_recursive_value_define>>::value);
...
static_assert(IsSame<SymbolicSineHalf, RationalHalfExpected>::value);
static_assert(IsSame<SymbolicCosHalf, RationalHalfExpected>::value);
static_assert(IsSame<VectorDotExample, Int<32>>::value);
static_assert(IsSame<VectorMeanExample, RationalFiveHalves>::value);
static_assert(IsSame<MatrixProductExample, MatrixProductExpected>::value);
static_assert(IsSame<MatrixDeterminantExample, Int<-2>>::value);
static_assert(IsSame<ComplexSumExample, ComplexSumExpected>::value);
static_assert(IsSame<ScriptMathSymbolicResult, RationalHalfExpected>::value);
static_assert(IsSame<ScriptVectorMathResult, Int<32>>::value);
static_assert(IsSame<ScriptMatrixMathResult, MatrixProductExpected>::value);
static_assert(IsSame<ScriptComplexMathResult, ComplexSumExpected>::value);
static_assert(IsSame<ScriptStatsMathResult, RationalFiveHalves>::value);
static_assert(IsSame<TypeCheckScript_t<generated_scripts::math_symbolic_source>, RationalType>::value);
static_assert(IsSame<TypeCheckScript_t<generated_scripts::math_approx_source>, RealType>::value);
static_assert(IsSame<TypeCheckScript_t<generated_scripts::vector_math_source>, IntType>::value);
static_assert(IsSame<TypeCheckScript_t<generated_scripts::matrix_math_source>, MatrixType<IntType, 2, 2>>::value);
static_assert(IsSame<TypeCheckScript_t<generated_scripts::complex_math_source>, ComplexType<IntType>>::value);
static_assert(IsSame<TypeCheckScript_t<generated_scripts::stats_math_source>, RationalType>::value);
...
static_assert(pretty_string_view_v<SymbolicSqrtTwo> == "(sqrt 2)");
static_assert(to_rational_string_view_v<ScriptMathSymbolicResult> == "1/2");
static_assert(pretty_string_view_v<ScriptMatrixMathResult> == "(matrix (vector 19 22) (vector 43 50))");
static_assert(pretty_string_view_v<MatrixInverseExample> == "(matrix (vector -2 1) (vector 3/2 -1/2))");
static_assert(pretty_string_view_v<ScriptComplexMathResult> == "(complex 4 6)");
static_assert(to_rational_string_view_v<ScriptStatsMathResult> == "5/2");
static_assert(to_decimal_string_view_v<ApproxSqrtTwo> == "1.414213562373");
static_assert(to_decimal_string_view_v<ScriptMathApproxResult> == "2.718281828459");
static_assert(to_decimal_string_view_v<ApproxComplexMagnitudeExample> == "2.236067977499");
static_assert(reduction_count_v<DotStats> == 1);
static_assert(node_count_v<DotStats> == 1);
