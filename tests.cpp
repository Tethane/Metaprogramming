...
using HaskellFactorialResult = EvalHaskellScript_t<generated_haskell_scripts::factorial_source>;
using HaskellFactorialType = TypeCheckHaskellScript_t<generated_haskell_scripts::factorial_source>;
using HaskellMaybeResult = EvalHaskellScript_t<generated_haskell_scripts::maybe_int_source>;
using HaskellMaybeType = TypeCheckHaskellScript_t<generated_haskell_scripts::maybe_int_source>;
using HaskellStreamResult = EvalHaskellScript_t<generated_haskell_scripts::stream_take_source>;
using HaskellStreamType = TypeCheckHaskellScript_t<generated_haskell_scripts::stream_take_source>;
using HaskellIoRun = RunHaskellScript_t<generated_haskell_scripts::io_demo_source, 0>;
using HaskellIoType = TypeCheckHaskellScript_t<generated_haskell_scripts::io_demo_source>;
using HaskellWhereResult = EvalHaskellSource_t<"main :: Int; main = let { y = 20 + 22 } in y;">;
using HaskellLambdaResult = EvalHaskellSource_t<"main :: Int; main = (\\x -> x + 1) 41;">;
using BigintScriptResourceName = String<'b', 'i', 'g', 'i', 'n', 't', '_', 's', 'u', 'm', '.', 'l', 'i', 's', 'p'>;
using BigintScriptTextExpected = fixed_string_to_string_t<generated_resources::ResourceByName<BigintScriptResourceName>::source>;
...
static_assert(IsSame<HaskellFactorialResult, Int<120>>::value);
static_assert(IsSame<HaskellFactorialType, IntType>::value);
static_assert(IsSame<HaskellMaybeResult, Int<42>>::value);
static_assert(IsSame<HaskellMaybeType, IntType>::value);
static_assert(IsSame<HaskellStreamResult, List<Int<1>, Int<1>, Int<1>, Int<1>, Int<1>>>::value);
static_assert(IsSame<HaskellStreamType, ListType<IntType>>::value);
static_assert(IsSame<HaskellWhereResult, Int<42>>::value);
static_assert(IsSame<HaskellLambdaResult, Int<42>>::value);
static_assert(IsSame<HaskellIoType, IOType<StringType>>::value);
static_assert(IsSame<to_effect_value_t<HaskellIoRun>, BigintScriptTextExpected>::value);
...
static_assert(to_output_string_view_v<HaskellIoRun> == "begin\n");
static_assert(to_seed_v<HaskellIoRun> == 12345);
